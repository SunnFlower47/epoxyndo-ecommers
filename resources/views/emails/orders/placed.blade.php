                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff; border-radius: 16px; overflow: hidden; border: 1px solid #E2E8F0; box-shadow: 0 4px 12px rgba(15, 23, 42, 0.03);">
                    ...
                    <tr>
                        <td style="padding: 40px 40px 20px 40px; font-size: 16px; color: #334155;">
                            ...
                            <p style="margin: 0 0 24px 0; font-size: 15px; color: #64748B;">Terima kasih telah berbelanja di {{ $companyName }}. Pesanan Anda dengan nomor invoice **{{ $order->order_number }}** telah kami terima dan saat ini sedang menunggu pembayaran.</p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #F8FAFC; border-radius: 12px; border: 1px solid #E2E8F0; padding: 20px; margin-bottom: 24px;">
                                ...
                                <tr>
                                    <td style="font-size: 14px; color: #64748B; padding-bottom: 8px;">Status Pembayaran</td>
                                    <td align="right" style="font-size: 14px; padding-bottom: 8px;">
                                        <span style="background-color: #FEF3C7; color: #D97706; padding: 4px 10px; border-radius: 9999px; font-size: 12px; font-weight: 600;">Menunggu Pembayaran</span>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style="font-size: 15px; font-weight: 700; color: #0F172A; padding-top: 12px;">Total Pembayaran</td>
                                    <td align="right" style="font-size: 18px; font-weight: 800; color: #008943; padding-top: 12px;">Rp {{ number_format($order->grand_total, 0, ',', '.') }}</td>
                                </tr>
                            </table>
