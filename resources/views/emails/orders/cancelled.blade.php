                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff; border-radius: 16px; overflow: hidden; border: 1px solid #E2E8F0; box-shadow: 0 4px 12px rgba(15, 23, 42, 0.03);">
                    ...
                    <tr>
                        <td style="padding: 40px 40px 20px 40px; font-size: 16px; color: #334155;">
                            ...
                            <p style="margin: 0 0 24px 0; font-size: 15px; color: #64748B;">Mohon maaf, pesanan Anda dengan nomor invoice **{{ $order->order_number }}** telah <strong style="color: #DC2626;">Dibatalkan</strong>.</p>
                            
                            <p style="margin: 0 0 24px 0; font-size: 15px; color: #64748B;">Pembatalan ini dapat terjadi karena beberapa hal, seperti pesanan melewati batas waktu pembayaran, stok produk tidak tersedia, atau permintaan pembatalan dari Anda maupun pihak kurir.</p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #F8FAFC; border-radius: 12px; border: 1px solid #E2E8F0; padding: 20px; margin-bottom: 24px;">
                                <tr>
                                    <td style="font-size: 14px; color: #64748B; padding-bottom: 8px;">Nomor Pesanan</td>
                                    <td align="right" style="font-size: 14px; font-weight: 700; color: #0F172A; padding-bottom: 8px;">{{ $order->order_number }}</td>
                                </tr>
                                <tr>
                                    <td style="font-size: 14px; color: #64748B; padding-bottom: 8px;">Status Pesanan</td>
                                    <td align="right" style="font-size: 14px; padding-bottom: 8px;">
                                        <span style="background-color: #FEE2E2; color: #DC2626; padding: 4px 10px; border-radius: 9999px; font-size: 12px; font-weight: 600;">Dibatalkan</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="font-size: 14px; color: #64748B; padding-bottom: 8px; border-bottom: 1px dashed #E2E8F0;">Metode Pembayaran</td>
                                    <td align="right" style="font-size: 14px; font-weight: 600; color: #334155; padding-bottom: 8px; border-bottom: 1px dashed #E2E8F0;">{{ strtoupper($order->payment_method ?? 'Transfer / Gateway') }}</td>
                                </tr>
                                <tr>
                                    <td style="font-size: 15px; font-weight: 700; color: #0F172A; padding-top: 12px;">Total Pesanan</td>
                                    <td align="right" style="font-size: 18px; font-weight: 800; color: #DC2626; padding-top: 12px;">Rp {{ number_format($order->grand_total, 0, ',', '.') }}</td>
                                </tr>
                            </table>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 24px;">
                                <tr>
                                    <td align="center">
                                        <a href="{{ config('app.url') }}/shop" style="background-color: #DC2626; color: #ffffff; text-decoration: none; display: inline-block; padding: 12px 30px; font-weight: 700; font-size: 15px; border-radius: 8px; box-shadow: 0 4px 6px rgba(220, 38, 38, 0.15);">Belanja Kembali</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td align="center" style="background-color: #F8FAFC; padding: 30px 40px; border-top: 1px solid #E2E8F0; font-size: 12px; color: #94A3B8; text-align: center;">
                            ...
                            <p style="margin: 0; line-height: 1.8;">
                                @if(!empty($settings->support_email))
                                    Email: <a href="mailto:{{ $settings->support_email }}" style="color: #DC2626; text-decoration: none;">{{ $settings->support_email }}</a>
                                @endif
                                @if(!empty($settings->support_phone))
                                    &nbsp;&bull;&nbsp; Hubungi Kami: <a href="tel:{{ $settings->support_phone }}" style="color: #DC2626; text-decoration: none;">{{ $settings->support_phone }}</a>
                                @endif
                            </p>
